...
`v0.1.0` 已冻结 **M0 — First Ripple**；正式封版状态与评测边界见 [`M0 封版报告`](docs/evals/runs/2026-08-12-v0.1.0-m0-release-pass.md)。当前 `main` 已进入 **M1 — Real Story** 启动状态；在具体 M1 Issue 明确用户结果与验收标准前，不扩大产品范围，M0 代码只接受 P0/P1 bug 修复。
